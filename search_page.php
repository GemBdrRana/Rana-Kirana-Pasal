...
<html lang="en">
<head>
  <link rel="icon" href="images/searchpage.ico" size="25*25" type="image/x-icon" />
...
<section class="search-form">
   <form action="" method="post">
      <input type="text" name="search_box" placeholder="search here..." maxlength="100" class="box" required style="border: none;">
      <button type="submit" class="fas fa-search" name="search_btn" style="background: -webkit-linear-gradient(right, #2dbd6e, #2dbd6e);
         color: white;"></button>
   </form>
</section>
...
<section class="products" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
         ...
         echo '<p class="empty" style="border:none;box-shadow: rgba(50, 50, 93, 0.25) 0px 50px 100px -20px, rgba(0, 0, 0, 0.3) 0px 30px 60px -30px, rgba(10, 37, 64, 0.35) 0px -2px 6px 0px inset;color:green">no products found!</p>';
      }
   }
   ?>
